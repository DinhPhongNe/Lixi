...
text_main = pygame.font.SysFont("Times New Roman", 100, True).render("RÚT BAO LÌ XÌ", True, "#FFFFFF")

text_play = pygame.font.SysFont("Times New Roman", 70, True).render("CHỌN SỐ LƯỢNG BAO LÌ XÌ", True, "#FFFFFF")

button_play = Button.Button_TEXT("Play",(None, 50), 300, 100, (screen.get_width() / 2 - 150, screen.get_height() / 2),(0, 255, 0),10)
button_play.border(border_thickness=10)

button_quit = Button.Button_TEXT("Quit",(None, 50), 300, 100, (screen.get_width() / 2 - 150,screen.get_height() / 2 + 150), (255, 0, 0),10)
button_quit.border(border_thickness=10)

button_return = Button.Button_TEXT("Return", (None, 50), 200, 100, (-25, -25), (50, 50, 50), 30)

button_submit = Button.Button_TEXT("Submit",(None, 50), 200, 70, (screen.get_width() / 2 - 100, screen.get_height() / 2 + 100), (0, 255, 0), 10)

button_submit2 = Button.Button_TEXT("Submit", (None, 50), 200, 70, (screen.get_width() / 2 + 200, screen.get_height() / 2 - 300), (0, 255, 0), 10)

button_shuffle = Button.Button_TEXT("Shuffle",(None, 50), 200, 70, (screen.get_width() / 2 - 100, screen.get_height() / 2 - 300), (0, 255, 0), 10)
...
def main():
    ...
    screen.blit(text_main, (screen.get_width() / 2 -
                text_main.get_width() / 2, text_main.get_height() - 50))
...
def choose_value():
    ...
    button_image_1k.draw(screen)
    button_image_5k.draw(screen)
...
def shuffle():
    ...
    if check_move:
        ...
        if (button_image3_baolixi1.x == list_pos_random[0]
            ...
            button_image3_baolixi1.image_rect.topleft = (
                button_image3_baolixi1.x, button_image3_baolixi1.y)
            button_image3_baolixi2.image_rect.topleft = (
                button_image3_baolixi2.x, button_image3_baolixi2.y)
            button_image3_baolixi3.image_rect.topleft = (
                button_image3_baolixi3.x, button_image3_baolixi3.y)
            button_image3_baolixi4.image_rect.topleft = (
                button_image3_baolixi4.x, button_image3_baolixi4.y)
            button_image3_baolixi5.image_rect.topleft = (
                button_image3_baolixi5.x, button_image3_baolixi5.y)
            button_image3_baolixi6.image_rect.topleft = (
                button_image3_baolixi6.x, button_image3_baolixi6.y)
    ...
    if value >= 0:
        ...
        screen.blit(text, (screen.get_width() / 2 -
                    text.get_width() / 2, screen.get_height() / 2 - 150))
...
class Image_Button2:
    def __init__(self, x=0, y=0, image=None, space=0, disable=True, area=None):
        ...
        self.list_image = [image_1k, image_5k, image_10k, image_20k, image_50k, image_100k, image_200k, image_500k]
        self.list_value = [1000, 5000, 10000, 20000, 50000, 100000, 200000, 500000]
        self.move = 0
        self.start = 0
    ...
    def draw(self, screen, td, mode):
        if not self.disable:
            if self.active:
                ...
                self.image2 = pygame.transform.rotate(
                    self.list_image[self.pos], 90)
                self.move += 200 * td
                if mode:
...
image_1k = pygame.image.load("asset\\Image\\1k.jpg").convert_alpha()
image_1k = pygame.transform.smoothscale(
    image_1k, (image_1k.get_width() * scale_1_5k, image_1k.get_height() * scale_1_5k))
button_image_1k = Image_Button1(100, 200, image_1k, 50)

image_5k = pygame.image.load("asset\\Image\\5k.jpg").convert_alpha()
image_5k = pygame.transform.smoothscale(
    image_5k, (image_5k.get_width() * scale_1_5k, image_5k.get_height() * scale_1_5k))
button_image_5k = Image_Button1(100, 300, image_5k, 50)

image_10k = pygame.image.load("asset\\Image\\10k.jpg").convert_alpha()
image_10k = pygame.transform.smoothscale(
    image_10k, (image_10k.get_width() * scale, image_10k.get_height() * scale))
button_image_10k = Image_Button1(100, 400, image_10k, 50)

image_20k = pygame.image.load("asset\\Image\\20k.jpg").convert_alpha()
image_20k = pygame.transform.smoothscale(
    image_20k, (image_20k.get_width() * scale, image_20k.get_height() * scale))
button_image_20k = Image_Button1(100, 500, image_20k, 50)

image_50k = pygame.image.load("asset\\Image\\50k.jpg").convert_alpha()
image_50k = pygame.transform.smoothscale(
    image_50k, (image_50k.get_width() * scale, image_50k.get_height() * scale))
button_image_50k = Image_Button1(100, 600, image_50k, 50)

image_100k = pygame.image.load("asset\\Image\\100k.jpg").convert_alpha()
image_100k = pygame.transform.smoothscale(
    image_100k, (image_100k.get_width() * scale, image_100k.get_height() * scale))
button_image_100k = Image_Button1(100, 700, image_100k, 50)

image_200k = pygame.image.load("asset\\Image\\200k.jpg").convert_alpha()
image_200k = pygame.transform.smoothscale(
    image_200k, (image_200k.get_width() * scale, image_200k.get_height() * scale))
button_image_200k = Image_Button1(100, 800, image_200k, 50)

image_500k = pygame.image.load("asset\\Image\\500k.jpg").convert_alpha()
image_500k = pygame.transform.smoothscale(
    image_500k, (image_500k.get_width() * scale, image_500k.get_height() * scale))
button_image_500k = Image_Button1(100, 900, image_500k, 50)
...
area = [button_image_1k.image_rect, button_image_5k.image_rect, button_image_10k.image_rect, button_image_20k.image_rect, button_image_50k.image_rect, button_image_100k.image_rect, button_image_200k.image_rect, button_image_500k.image_rect]
...
button_image2_baolixi7 = Image_Button2(1275, 400, image_baolixi, 50, area=area)
button_image2_baolixi8 = Image_Button2(1425, 400, image_baolixi, 50, area=area)
...
button_image3_baolixi7 = Image_Button3(x * 6 + space, 400, image_baolixi, 50)
button_image3_baolixi8 = Image_Button3(x * 7 + space, 400, image_baolixi, 50)

button_plus = Button.Button_TEXT("+", (None, 40), 50, 40, (screen.get_width() / 2 - 300, screen.get_height() / 4 - 100), (0, 255, 0), 10)

button_minus = Button.Button_TEXT("-", (None, 40), 50, 40, (screen.get_width() / 2 - 300, screen.get_height() / 4 - 100), (255, 0, 0), 10)

button_reset = Button.Button_TEXT("RESET", (None, 35), 100, 50, (screen.get_width() / 2 - 300, screen.get_height() / 4 - 150), (255, 0, 0), 10)
...
move = 0
check_move = False
list_pos_button = [button_image3_baolixi1.x, button_image3_baolixi2.x, button_image3_baolixi3.x, button_image3_baolixi4.x, button_image3_baolixi5.x, button_image3_baolixi6.x]
list_pos_random = []

manager = pygame_gui.UIManager(screen.get_size())

drop_down = pygame_gui.elements.UIDropDownMenu(options_list=["1", "2", "3", "4", "5", "6"] , starting_option="1", relative_rect=pygame.Rect(screen.get_width() / 2 - 150, screen.get_height() / 2 - 125, 300, 50) )
...
while run:
    ...
    fps_screen = pygame.font.Font(None, 30).render(
        "FPS {}".format(int(clock.get_fps())), True, (255, 255, 255))
    rect_fps = pygame.rect.Rect(0, screen.get_height(
    ) - 20, fps_screen.get_width(), fps_screen.get_height())
    screen.blit(fps_screen, (0, screen.get_height() - 20))

    click = pygame.mouse.get_pressed()
    click = [str(i) for i in click]
    click_label = pygame.font.Font(None, 20).render(
        "{}".format(" ".join(click)), True, "#FFFFFF")
    screen.blit(click_label, (screen.get_width() -
                click_label.get_width(), 20))
